...
export function ProductList({ addToCart, removeFromCart, products, cartItems }) {
    return (
                        ...
                        <div className="card ma-16">
                            ...
                            <div className="card-actions justify-content-center pa-4">
                                {!cartItems.some((p) => p.id === product.id) ? (
                                    <button className="x-small outlined" data-testid="btn-item-add" onClick={() => addToCart(product)}>
                                        Add To Cart
                                    </button>
                                ) : (
                                    <button className="x-small danger" data-testid="btn-item-remove" onClick={() => removeFromCart(product)}>
                                        Remove
                                    </button>
                                )}
                            </div>
